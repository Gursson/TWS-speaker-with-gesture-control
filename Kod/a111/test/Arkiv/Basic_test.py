...
def main():
    ...
    while not interrupt_handler.got_signal:#for i in range(lengd):
        ...
        index = np.argmax(data, axis = None, out = None);
        print(index)

        #Check if hand is in place, go in menu
        if 70 < index < 120 and Menu_timer_start == 0: #Menu range
        ...
        if Menu_timer_start > 0: #Inne i menyn
            ...
            elif 260 < index < 413: #Volume up interval
            ...
            elif 70 < index < 150:#Volyume down interval
   ...
   #        Pause/Play
   #         elif 70 < SENSOR1 and SENSOR 2 < 120:
      ...
      #              Menu_timer_start = time.time()
       #             Pause_Play_counter = 0
        #            print("Pause/Play")
         ...
         #       
          #      formatted_time = "{:.2f}".format(time.time() - Menu_timer_start)
